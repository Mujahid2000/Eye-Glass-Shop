    ...
    return (
        <div className="bg-[#EAEAEA] h-[36.5rem] md:h-[35rem] lg:h-[40rem] xl:h-[45rem] 2xl:h-[60rem] flex flex-col md:flex-col lg:flex-row xl:flex-row 2xl:flex-row place-items-center items-center justify-center gap-2 mt-0">
            ...
            <div className='ml-0 flex items-center md:ml-24 lg:ml-48 xl:ml-64 2xl:ml-36 '>
                ...
                <button className="inline-flex active:bg-[#141414] items-center px-4 md:px-8 py-3 gap-3 -ml-[11rem] md:-ml-[25rem] lg:-ml-[10rem] xl:ml-[15rem] 2xl:ml-[20rem] mt-[16rem] md:mt-[16rem] lg:-mt-[22rem] xl:mt-[6rem] 2xl:mt-[10rem] absolute z-40 bg-[#383838]  text-white text-lg font-medium rounded-md"><FaShoppingCart/>Restore</button>
            </div>
