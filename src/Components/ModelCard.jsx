           ...
           <div>
             ...
             <div className="relative max-w-[643px] max-h-[633px] my-9">
                ...
                <div className="absolute inset-0 flex  justify-center">
                    <div className="w-[30rem] h-[14rem] mt-[30rem] 2xl:mt-[23rem] bg-white shadow-lg rounded-lg overflow-hidden z-30">
            ...
            {/* card3 */}
            <div>
                <div className="relative max-w-[643px] max-h-[509px] mt-[16rem] md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-0">
                <img src="https://i.ibb.co/w0T1F5y/Image-3.png" alt="" className="relative"/>
                <div className="absolute inset-0 flex  justify-center">
                    <div className="w-[30rem] h-[14rem] mt-[25rem] 2xl:mt-[15.5rem] bg-white shadow-lg rounded-lg overflow-hidden z-30">
                        <div className="text-center px-6 py-4">
                            <div className="py-4">
                                <h3 className="text-[#383838] text-[25px] font-bold leading-[35px] tracking-normal text-center">Bravo Sunglasses</h3>
                                <p id="description" className="text-sm mt-3 font-medium text-gray-600">Up to 80% off on selected item</p>
            ...
            <div className="">
                {/* card 2 */}
            <div>
                <div className="relative max-w-[643px] max-h-[509px] my-9 mt-[13rem] md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-0">
                ...
                <div className="relative max-w-[643px] max-h-[633px] mt-[16rem] md:mt-0 lg:mt-0 xl:mt-0 2xl:mt-0">
